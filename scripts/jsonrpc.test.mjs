...
try {
  ...
  // ---------------------------------------------------------------- framing
  {
    ...
    console.log('one frame across single-byte chunks OK')
  }

  {
    ...
    console.log('several frames per chunk, remainder carried over OK')
  }

  {
    ...
    console.log('empty chunk, blank lines, CRLF OK')
  }
  ...
  // ------------------------------------------------------------- noise gate
  {
    ...
    console.log(`${noise.length} unparsable / non-frame lines skipped, stream still live OK`)
  }

  {
    ...
    console.log('unknown frame members tolerated OK')
  }
  ...
  // --------------------------------------------------------- requests (out)
  {
    ...
    console.log('request ids, out-of-order responses, unknown-id response ignored OK')
  }

  {
    ...
    console.log('malformed response rejects with paths only, no content OK')
  }

  {
    ...
    console.log('error responses, missing message, string-id response OK')
  }

  {
    ...
    console.log('notify() writes an id-less frame OK')
  }
  ...
  // ---------------------------------------------------------- requests (in)
  {
    ...
    console.log('incoming requests: result, string id, handler failure, unknown method, notification OK')
  }
  ...
  // ------------------------------------------------------- issuePaths alone
  {
    ...
    console.log('issuePaths reports paths and codes only OK')
  }
  ...
  // ------------------------------------------------- size: no cap (TODAY’s behaviour)
  {
    ...
    console.log('1 MiB frame passes: no size cap in jsonrpc.ts today OK')
  }
  ...
  // ------------------------- multi-byte UTF-8 on a chunk boundary (TODAY’s behaviour)
  {
    ...
    console.log('multi-byte UTF-8 split across chunks: corrupted (known defect, characterized) OK')
  }
  ...
  // ------------------------------------------------------------- DBG trace
  {
    ...
    console.log('DBG frame trace carries envelope only (method/id/dir/bytes) OK')
  }

  console.log('jsonrpc.test: PASS')
} catch (e) {
  console.error('jsonrpc.test: FAIL')
  console.error(e)
  process.exitCode = 1
} finally {
